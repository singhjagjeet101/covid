...
# Title - The title and introductory text and images are all written in Markdown formatstre here, using st.write()
...
def run():
    ...
    link = '[©Developed byJagjeet Singh](https://www.linkedin.com/in/jagjeet-singh-718222b2/)'
...
st.write('This smooths out the spikes somewhat and makes it easier to identify the real trend in cases.')
...
st.write('''
    Dashboard created by [Jagjeet Singh](https://www.linkedin.com/in/jagjeet-singh-718222b2/), with [Streamlit](https://www.streamlit.io).
